		...
		for inv in objects:
			...
			for line in inv.invoice_line:     
				...
				c_specs = [
					...
					('line_product_id', 1, 0, 'text', ('[' + line.product_id.default_code +']' + ' ' + line.product_id.name_template  if line.product_id else '-'), None, c_line_cell_style),
					('line_name', 1, 0, 'text', line.name, None, c_line_cell_style),
					('line_account_id', 1, 0, 'text', ('[' + line.account_id.code  +']' + ' ' + line.account_id.name if line.account_id else '-'), None, c_line_cell_style),
