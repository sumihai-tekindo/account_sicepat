		...
		for inv in objects:
			...
			for line in inv.invoice_line:     
				...
				c_specs = [
					...
					('line_product_id', 1, 0, 'text', ('[' + line.product_id.default_code if line.product_id else '-'  +']' + ' ' + Line.product_id.name_template if line.product_id else '-'  ), None, c_line_cell_style),
					# ('line_product_id', 1, 0, " ", None),
					('line_name', 1, 0, 'text', line.name, None, c_line_cell_style),
					('line_account_id', 1, 0, 'text', ('[' + line.account_id.code if line.product_id else '-'  +']' + ' ' + line.account_id.name), None, c_line_cell_style),
					...
					('line_account_analytic_id', 1, 0, 'text', line.account_analytic_id.name if line.account_analytic_id else '-', None, c_line_cell_style),
