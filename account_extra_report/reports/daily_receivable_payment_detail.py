...
class daily_receivable_payment_detail(ReportXlsx):
...
daily_receivable_payment_detail('report.daily.receivable.payment.detail', 'account.move.line',parser=partner_balance)
