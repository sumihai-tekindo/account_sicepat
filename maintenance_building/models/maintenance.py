...
class asset_rental(osv.Model):
	...
	_columns = {
		...
		'expiration_date': fields.date('Expire Date', help='Date when the coverage of the contract expirates (by default, one year after begin date)'),
		...
		# 'sum_cost': fields.s(_get_sum_cost, type='float', string='Indicative Costs Total'),
