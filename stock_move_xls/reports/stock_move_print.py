...
class stock_move_xls(report_xls):
    ...
    def generate_xls_report(self, _p, _xs, data, objects, wb):
        ...
        for rec in objects:
            ...
            max_len[7]=len(str(rec.name)) > max_len[7] and len(str(rec.name)) or max_len[7]
            ...
            max_len[4]=len(str(prod)) > max_len[4] and len(str(prod)) or max_len[4]
